...
class PluralRule:
    ...
    # ----------------------------------------
    @classmethod
    def from_header(cls, header: str) -> PluralRule:
        """
        ...
        py_expr = _compile_plural_expr(raw_expr)
    ...
    @classmethod
    def from_expression(cls, expr: str, nplurals: int) -> PluralRule:
        """
        ...
        Example:
            ...
            rule(2)  # -> 1
        """
        py_expr = _compile_plural_expr(expr)
...
def _convert_ternary(expr: str) -> str:
    ...
    # --- NEW: unwrap outer parentheses to avoid depth confusion ---
    ...
    cond_py = _convert_ternary(unwrap(cond))
    true_py = _convert_ternary(unwrap(true_part))
    false_py = _convert_ternary(unwrap(false_part))
